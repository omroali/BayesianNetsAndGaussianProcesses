...
class PDF_Generator(BayesNetReader, NB_Classifier):
    ...
    def __init__(self, configfile_name, datafile_name):
        self.bn = None # for instance of BayesNetReader
        self.nbc = None # for instance of NB_Classifier
        self.means = {} # mean vectors of random variables
        self.stdevs = {} # standard deviations of random variables
        self.regressors = {} # regression models for random variables
