...
df = pd.read_csv('data/continuous/cardiovascular_data-original-test.csv', encoding='utf-8')
...
for i in range(0, num_rows, split_size):
    ...
    df_subset.to_csv(f'data/split-cardiovascular_data-original-train{i//split_size + 1}-train.csv', index=False)